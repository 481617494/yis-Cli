...
//!
//! In dev mode, watches ~/.yis/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.yis/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.yis/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = xai_yis_config::user_yis_home()
