...
//! Dark themes (YisNight, TokyoNight) share `yis-night.tmTheme`;
//! YisDay uses `yis-day.tmTheme` with deepened colors for light backgrounds.

use std::sync::OnceLock;

pub use xai_yis_markdown::Syntect;
...
pub fn get_syntect() -> &'static Syntect {
    match crate::theme::Theme::current_kind() {
        ...
        | ThemeKind::Auto => SYNTECT_GROKNIGHT
            .get_or_init(|| Syntect::new(include_bytes!("../assets/yis-night.tmTheme"))),
        ThemeKind::TokyoNight => SYNTECT_TOKYONIGHT
            .get_or_init(|| Syntect::new(include_bytes!("../assets/tokyo-night.tmTheme"))),
        ThemeKind::YisDay => SYNTECT_GROKDAY
            .get_or_init(|| Syntect::new(include_bytes!("../assets/yis-day.tmTheme"))),
    }
}
