...
///
/// - `osc52_sink`: when `yis wrap` is capturing this process's output (see
...
mod tests {
    ...
    // `yis wrap` sink: a brand that does NOT natively support OSC 52 (the
    ...
    // container override is deliberately narrow; `yis wrap` is the SSH path.
    #[test]
