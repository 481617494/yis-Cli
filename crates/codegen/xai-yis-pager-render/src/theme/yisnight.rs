//! YisNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// YisNight palette — neutral gray base + TokyoNight accent colors.
//
...
mod tests {
    ...
    fn test_yisnight_theme() {
        let theme = Theme::yisnight();
