...
2. **Scope** - present the user with two options:
   - **Project** (Recommended): `<repo-root>/.yis/skills/<name>/SKILL.md` - available only in this repo, shareable with teammates
   - **User**: `~/.yis/skills/<name>/SKILL.md` - available in all projects
...
Where `<SKILL_DIR>` is:
- User scope: `~/.yis/skills/<name>`
- Project scope: `<repo-root>/.yis/skills/<name>`
