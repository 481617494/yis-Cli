...
//
// State is persisted to `~/.yis/claude_import_state.json`.
...
use xai_yis_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.yis/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::yis_home::yis_home().join("claude_import_state.json")
}
