...
impl TokenType {
    ...
    pub(crate) fn from_auth(auth: Option<&YisAuth>) -> Self {
        match auth {
            None => Self::None,
    ...
    pub(crate) fn telemetry_kind(self) -> xai_yis_telemetry::events::AuthTokenKind {
        use xai_yis_telemetry::events::AuthTokenKind as K;
        match self {
