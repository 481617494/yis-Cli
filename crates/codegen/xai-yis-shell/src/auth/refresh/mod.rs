...
pub(crate) trait ExternalCommandRunner: Send + Sync {
    ...
    fn run_external_command(&self, command: &str) -> Option<YisAuth>;
}
...
impl RefreshOutcome {
    ...
    pub(crate) fn success(auth: YisAuth) -> Self {
...
mod tests {
    use super::*;
    use crate::auth::{AuthMode, YisAuth, YisComConfig};
