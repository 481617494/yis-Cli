...
pub enum SessionCommand {
    ...
    ReloadPlugins {
        registry: Option<std::sync::Arc<xai_yis_agent::plugins::PluginRegistry>>,
    },
    /// Re-discover the session's own project hooks (`.yis/hooks`,
    ...
    SnapshotToolDefinitions {
        respond_to: oneshot::Sender<Vec<xai_yis_sampling_types::ToolSpec>>,
    },
    ...
    KillBackgroundTask {
        task_id: String,
        respond_to: oneshot::Sender<Result<xai_yis_tools::types::KillOutcome, String>>,
    },
    DeleteScheduledTask {
        task_id: String,
    ...
    ListTasks {
        respond_to: oneshot::Sender<Option<Vec<xai_yis_tools::types::TaskSnapshot>>>,
    },
    ...
    PluginsList {
        respond_to:
            oneshot::Sender<Option<std::sync::Arc<xai_yis_agent::plugins::PluginRegistry>>>,
    },
    ...
    /// tool-free model call (default `yis-build-0.1` when available via
    ...
    TakeHarnessTraceTurns {
        respond_to:
            oneshot::Sender<Vec<Vec<xai_yis_sampling_types::conversation::ConversationItem>>>,
    },
