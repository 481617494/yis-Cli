...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<xai_yis_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(xai_yis_tools::implementations::yis_build::update_goal::UpdateGoalInput),
    Channel(xai_yis_tools::implementations::yis_build::update_goal::UpdateGoalEnvelope),
}
