...
#[cfg(test)]
pub(crate) async fn test_agent_default() -> xai_yis_agent::Agent {
...
#[cfg(test)]
pub(crate) async fn test_agent_with_goal_tool() -> xai_yis_agent::Agent {
    use xai_yis_tools::implementations::yis_build::update_goal::UpdateGoalTool;
...
#[cfg(test)]
pub(crate) async fn test_yis_build_agent_with_todo() -> xai_yis_agent::Agent {
    use xai_yis_tools::implementations::yis_build::todo::TodoWriteTool;
    use xai_yis_tools::registry::types::ToolConfig;
...
#[cfg(test)]
pub(crate) async fn test_agent_with_plan_tools() -> xai_yis_agent::Agent {
    use xai_yis_tools::implementations::yis_build::enter_plan_mode::EnterPlanModeTool;
    use xai_yis_tools::implementations::yis_build::exit_plan_mode::ExitPlanModeTool;
    use xai_yis_tools::registry::types::ToolConfig;
...
pub(crate) async fn test_agent_with_tools(
    tools: Vec<xai_yis_tools::registry::types::ToolConfig>,
) -> xai_yis_agent::Agent {
    test_agent_from_config(
        xai_yis_tools::registry::types::ToolServerConfig {
            tools,
            behavior_preset: None,
        },
        xai_yis_agent::AgentDefinition::default_yis_build(),
        std::sync::Arc::new(xai_yis_tools::computer::local::LocalTerminalBackend::new()),
    )
    .await
}
#[cfg(test)]
async fn test_agent_from_config(
    ...
    definition: xai_yis_agent::AgentDefinition,
    backend: std::sync::Arc<dyn xai_yis_tools::computer::types::TerminalBackend>,
) -> xai_yis_agent::Agent {
    use xai_yis_tools::computer::local::LocalFs;
    use xai_yis_tools::computer::types::AsyncFileSystem;
    ...
    xai_yis_agent::Agent::new(
        definition,
        xai_yis_agent::PromptContext::default(),
        String::new(),
        tool_bridge,
        xai_yis_agent::ReminderPolicy::default(),
        xai_yis_agent::CompactionPolicy::default(),
        vec![],
        false,
    )
}
...
pub(crate) async fn create_test_actor_ex(
    ...
    let cwd = xai_yis_paths::AbsPathBuf::new(std::path::PathBuf::from("/tmp")).unwrap();
    let fs = Arc::new(xai_yis_workspace::file_system::MockFs::new(
        cwd.to_path_buf(),
    ));
    ...
    let actor = SessionActor {
        ...
        permissions: xai_yis_workspace::permission::PermissionHandle::allow_all(),
        tool_context,
