//! AcpTerminalAdapter: implements `xai-yis-tools::TerminalBackend` using ACP gateway calls.
//!
//! This adapter enables bash tool execution over ACP (remote execution).
//! It translates xai-yis-tools' `TerminalBackend` trait into ACP protocol calls:
...
use xai_yis_tools::computer::types::{
...
/// Wraps xai-yis-shell's ACP gateway to satisfy xai-yis-tools' TerminalBackend.
