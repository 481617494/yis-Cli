...
use xai_yis_config_types::DisplayRefreshSettings;

pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "YIS_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "YIS_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`YIS_MIN_DRAW_MS` / `YIS_SCROLL_CADENCE_MS`).
