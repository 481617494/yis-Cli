...
/// Process-wide write lock for `~/.yis/config.toml`.
///
...
"#;
        ...
        assert_eq!(cfg.ui.auto_light_theme.as_deref(), Some("yisday"));
...
"#;
    ...
    mod resolve_auto_compact {
        ...
        /// Serialize tests that mutate `YIS_AUTO_COMPACT_THRESHOLD_PERCENT`.
    ...
    fn settings_helpers_target_correct_ui_fields() {
        ...
        let cfg = apply(|cfg| cfg.ui.auto_light_theme = Some("yisday".to_string()));
        assert_eq!(cfg.ui.auto_light_theme, Some("yisday".to_string()));
