...
//! xai-yis-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use xai_yis_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use xai_yis_workspace::session::file_state::FileStateHandle;
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn xai_yis_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<xai_yis_tools::implementations::yis_build::task::types::MonitorEventBuffer>,
...
impl ToolContext {
    pub fn new(
        ...
        let session_env = xai_yis_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
