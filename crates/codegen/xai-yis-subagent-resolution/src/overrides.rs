...
//!
//! Extracted from `xai-yis-shell/src/agent/subagent/` `resolve_effective_overrides()`.

use std::collections::HashMap;
use std::path::Path;

use serde::de::DeserializeOwned;
use xai_yis_tools::implementations::yis_build::task::types::SubagentRuntimeOverrides;
...
mod tests {
    use super::*;
    use xai_yis_tools::implementations::yis_build::task::types::ModelOverrideProvenance;
