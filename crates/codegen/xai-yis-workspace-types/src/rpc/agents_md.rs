...
/// Claude.md / `.yis/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.yis` and compat dirs.
...
/// Mirrors the serde shape of `xai-yis-agent`'s `AgentConfigFile`.
