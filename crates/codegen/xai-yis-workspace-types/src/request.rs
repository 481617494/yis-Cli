...
//!   here would force every consumer of `xai-yis-workspace-types`
...
//! (`xai-yis-workspace`) wraps this in its own `Request<T>` that
//! adds the cancellation token and extensions map.
//!
//! Splitting the envelope this way keeps `xai-yis-workspace-types`
