...
/// `YIS_WORKSPACE_DURABILITY_IDLE_HOLD_MAX_MS`.
...
pub struct ActivityTracker {
    ...
    /// `YIS_WORKSPACE_EVENTS_ENABLED` is off). Consumed by
...
impl ActivityTracker {
    ...
    /// idle-hold cap comes from `YIS_WORKSPACE_DURABILITY_IDLE_HOLD_MAX_MS`
...
/// The durability idle-hold cap from `YIS_WORKSPACE_DURABILITY_IDLE_HOLD_MAX_MS`.
fn durability_idle_hold_max_from_env() -> u64 {
    durability_idle_hold_from_raw(std::env::var("YIS_WORKSPACE_DURABILITY_IDLE_HOLD_MAX_MS").ok())
}
