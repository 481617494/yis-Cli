//! AcpFsAdapter: implements `xai-yis-tools::AsyncFileSystem` using ACP gateway calls.
//!
//! This adapter enables file tool execution over ACP (remote filesystem).
//! It translates xai-yis-tools' `AsyncFileSystem` trait into ACP protocol calls:
...
use xai_yis_tools::computer::types::{AsyncFileSystem, ComputerError};

/// Wraps xai-yis-shell's ACP gateway to satisfy xai-yis-tools' AsyncFileSystem.
///
