...
mod tests {
    ...
    fn identity(kind: ToolKind) -> ToolIdentity {
        ToolIdentity {
            tool_kind: kind,
            namespace: ToolNamespace::YisBuild,
    ...
    fn namespace_round_trips_snake_case_with_pascal_aliases() {
        ...
        fn wire_and_pascal(ns: ToolNamespace) -> (&'static str, &'static str) {
            match ns {
                ToolNamespace::YisBuild => ("yis_build", "YisBuild"),
                ToolNamespace::YisBuildConcise => ("yis_build_concise", "YisBuildConcise"),
                ToolNamespace::YisBuildHashline => ("yis_build_hashline", "YisBuildHashline"),
