...
use crate::implementations::yis_build::ask_user_question::AskUserQuestionInput;
use crate::implementations::yis_build::enter_plan_mode::EnterPlanModeInput;
use crate::implementations::yis_build::exit_plan_mode::ExitPlanModeInput;
use crate::implementations::yis_build::grep::GrepSearchInput;
use crate::implementations::yis_build::image_edit::ImageEditInput;
use crate::implementations::yis_build::image_gen::ImageGenInput;
use crate::implementations::yis_build::list_dir::ListDirInput;
use crate::implementations::yis_build::read_file::ReadFileInput;
use crate::implementations::yis_build::search_replace::SearchReplaceInput;
use crate::implementations::yis_build::todo::TodoWriteInput;
use crate::implementations::yis_build::update_goal::UpdateGoalInput;
use crate::implementations::yis_build::video_gen::{ImageToVideoInput, ReferenceToVideoInput};
use crate::implementations::yis_build::web_fetch::WebFetchInput;
use crate::implementations::yis_build::web_search::WebSearchInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::yis_build_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::yis_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::yis_build::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::yis_build::scheduler::delete::SchedulerDeleteInput),
    SchedulerList(crate::implementations::yis_build::scheduler::list::SchedulerListInput),
