...
///
/// Serializes to snake_case (`yis_build`, `mcp`, …) for the
...
/// (e.g. `"YisBuild:read_file"`); only the serde form goes on the wire.
#[derive(
    Debug,
    Clone,
    Copy,
...
pub enum ToolNamespace {
    #[serde(alias = "YisBuild")]
    YisBuild,
    #[serde(alias = "YisBuildConcise")]
    YisBuildConcise,
    #[serde(alias = "YisBuildHashline")]
    YisBuildHashline,
    #[serde(alias = "Codex")]
    Codex,
