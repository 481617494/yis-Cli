...
///
/// Use with `#[schemars(with = "YisIntegerSchema")]` on `Option<usize>` fields.
pub struct YisIntegerSchema;
impl schemars::JsonSchema for YisIntegerSchema {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "yis_integer_schema".into()
    }
