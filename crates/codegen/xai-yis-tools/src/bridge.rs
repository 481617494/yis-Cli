//! ToolBridge: adapter that wraps `xai-yis-tools`'s `ToolRegistry` and
...
impl ToolBridge {
    ...
    /// `Some("get_task_output")` for the yis_build agent and `None` for
    ...
    pub async fn delete_scheduled_task(
        ...
        use crate::implementations::yis_build::scheduler::types::{
...
mod tests {
    ...
    fn tool_kind_returns_registered_kind_per_namespace_and_none_for_unknown() {
        ...
        // PascalCase + yis_build's snake_case in one registry
