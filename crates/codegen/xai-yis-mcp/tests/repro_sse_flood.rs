...
//!
//! Run with: cargo test -p xai-yis-mcp --test repro_sse_flood -- --nocapture
...
use xai_yis_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use xai_yis_mcp::rmcp::ServiceExt;
use xai_yis_mcp::rmcp::transport::StreamableHttpClientTransport;
use xai_yis_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
