...
Learn how to install, configure, and extend Yis Cli, the terminal-based AI coding assistant from SpaceXAI.
...
Automate, script, and integrate Yis Cli with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `yis -p`, output formats, CI/CD integration, and piping |
