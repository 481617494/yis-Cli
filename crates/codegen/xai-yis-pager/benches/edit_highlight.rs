...
//!
//! ```text
//! cargo bench -p xai-yis-pager --bench edit_highlight
//! cargo bench -p xai-yis-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use xai_yis_pager::diff::{DiffHunk, DiffLine};
use xai_yis_pager::scrollback::blocks::tool::{
...
use xai_yis_pager::syntax::{Syntect, get_syntect};
