//! Criterion benchmarks for the xai-yis-pager rendering pipeline.
//!
...
use xai_yis_pager::scrollback::render::render_scrolled_entries_with_scratch;
use xai_yis_pager::scrollback::wrappers::EntryRenderer;
use xai_yis_pager::scrollback::{
