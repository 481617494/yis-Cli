#!/bin/bash
#
# Yis Cli installer (enterprise channel) — https://x.ai/cli/enterprise-install.sh
#
...
#   YIS_DEPLOYMENT_KEY=<key> bash <(curl -fsSL https://x.ai/cli/enterprise-install.sh)
#
