...
Terminal UI (TUI) for Yis Cli. Provides the interactive full-screen interface
...
- [Hook Examples](../xai-yis-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`xai-yis-hooks`)](../xai-yis-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`xai-yis-plugin-marketplace`)](../xai-yis-plugin-marketplace/) — marketplace source loading, scanning, and install
