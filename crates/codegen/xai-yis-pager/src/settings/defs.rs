...
//
// Concrete codes must match `xai_yis_voice::STT_LANGUAGES` (official Grok STT
    ...
    vec![
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` resolved to "yisnight".
                default: "yisnight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "yisnight".
                default: "yisnight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "yisday".
                default: "yisday",
                choices: CONCRETE_THEME_CHOICES,
                supports_preview: true,
            },
        ...
        SettingMeta {
            ...
            owner: SettingOwner::Shell,
            label: "默认模型",
            description: "新会话使用的模型。修改后也会切换当前会话。选择「(不覆盖)」可清除。也可使用 /model 或 Ctrl+M 切换。",
            keywords: &["model", "default", "agent", "llm", "yis", "switch", "模型", "切换"],
        ...
        // The `YIS_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        // Catalog = official STT languages (see xai_yis_voice::STT_LANGUAGES).
        SettingMeta {
        ...
        SettingMeta {
            ...
            owner: SettingOwner::Shell,
            label: "Fork 副模型",
            description: "Fork 时次要 agent 使用的模型。选择「(不覆盖)」可清除。",
            keywords: &[
                "fork",
                "secondary",
                "model",
