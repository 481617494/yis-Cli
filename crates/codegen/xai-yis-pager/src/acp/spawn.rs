...
pub async fn spawn_yis_shell(
    agent_config: AgentConfig,
    cancel: &CancellationToken,
    memory_config: Option<xai_yis_shell::config::MemoryConfig>,
) -> Result<SpawnedAgent> {
    ...
    // skills to ~/.yis/skills/), and model catalog construction.
    let (agent_config, models_manager) =
        xai_yis_shell::agent::init::bootstrap(&agent_config, &auth_manager, None)
