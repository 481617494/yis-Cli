...
pub use xai_yis_tools::implementations::yis_build::ask_user_question::{
...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<xai_yis_telemetry::events::CreditLimitChoice>,
    },
    ...
    FreeUsageUpsell {
        ...
        source: xai_yis_telemetry::events::SuperGrokUpsell,
    },
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> xai_yis_tools::implementations::yis_build::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: xai_yis_tools::implementations::yis_build::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
