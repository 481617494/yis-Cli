...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. YisNight's dark band leaking into YisDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default YisNight, dark) after the user switches —
        // painting a dark band on a light YisDay canvas.
