...
pub struct AgentView {
    ...
    pub context_state: Option<xai_yis_shell::session::ContextInfo>,
    ...
    /// Yis 模型管理（qoder-switch 式交互：列表/新增/编辑/删除）
    pub(crate) model_manager: Option<crate::views::model_manager::ModelManagerState>,
    ...
    pub(crate) deferred_session_mode: Option<xai_yis_tools::types::SessionMode>,
    ...
    match kind {
        ...
        LocalQuestionKind::CreditLimitUpsell { choices } => {
            ...
            let choice = choices
                .get(*idx)
                .copied()
                .unwrap_or(xai_yis_telemetry::events::CreditLimitChoice::PayAsYouGo);
            xai_yis_telemetry::session_ctx::log_event(
                xai_yis_telemetry::events::CreditLimitUpsellClicked {
        ...
        LocalQuestionKind::FreeUsageUpsell { source } => {
            ...
            xai_yis_telemetry::session_ctx::log_event(
                xai_yis_telemetry::events::SuperGrokUpsellClicked {
                    source,
                    auth_method: None,
                },
            );
...
fn translate_project_select(
    ...
    use xai_yis_telemetry::events::{ProjectPickerOutcome, ProjectPickerSelected};
    let project_dir_options = resolved_paths.len().saturating_sub(1);
    let emit = |outcome: ProjectPickerOutcome| {
        xai_yis_telemetry::session_ctx::log_event(ProjectPickerSelected {
            outcome,
...
fn question_visible_h(
    ...
    prompt_height: u16,
    question: &xai_yis_tools::implementations::yis_build::ask_user_question::Question,
    content_w: usize,
    preview: Option<&str>,
    fullscreen: bool,
    desc_cap: u16,
