#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    /// `yis login` guidance), not the generic re-auth prompt.
    #[test]
    ...
    fn child_compact_started_does_not_reset_context_used() {
        ...
        child_view.context_state = Some(xai_yis_shell::session::ContextInfo::from_notification(
            90_000, 131_072,
        ));
        agent
            .subagent_views
