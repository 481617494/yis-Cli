...
fn shorten_path(path: &str) -> &str {
    let memory_root = xai_yis_config::yis_home().join("memory");
...
**File:** /root/.yis/memory/MEMORY.md (lines 0-10)
```
## Project Conventions
...
"#;
        ...
        assert_eq!(results[0].path, "/root/.yis/memory/MEMORY.md");
...
**File:** /root/.yis/memory/ws/MEMORY.md (lines 1-5)
```
workspace content
```

### Result 2 (score: 0.42, source: session)
**File:** /root/.yis/memory/ws/sessions/2026-05-01.md (lines 10-20)
```
session content
```
"#;
