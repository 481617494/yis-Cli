...
// engine in `crates/common/xai-yis-compaction` operate over grok-build's
...
impl xai_yis_compaction::CompactionItem for ConversationItem {
    fn role(&self) -> xai_yis_compaction::CompactionRole {
        use xai_yis_compaction::CompactionRole;
    ...
    fn attachment_refs(&self) -> Vec<xai_yis_compaction::CompactionFileRef> {
        ...
        // image attachments need to survive into the `<yis_user_queries>`
        // preamble.
        Vec::new()
    }
}

impl xai_yis_compaction::CompactionItemFactory for ConversationItem {
...
/// ([stream/messages.rs:340](crates/codegen/xai-yis-sampler/src/stream/messages.rs))
...
///
/// This is `pub` so downstream crates (`xai-yis-shell`) can re-use it
...
impl From<ChatResponseMessage> for ConversationItem {
    fn from(msg: ChatResponseMessage) -> Self {
        ...
        // ([crates/codegen/xai-yis-sampler/src/stream/chat_completions.rs])
...
pub fn build_messages_request(req: &ConversationRequest) -> crate::messages::MessagesRequest {
    ...
    // output without tools. The yis-shell agent does NOT use this path — a
...
/// ([crates/codegen/xai-yis-sampler/src/stream/messages.rs]) instead
...
mod compaction_item_bridge_tests {
    use super::*;
    use xai_yis_compaction::{CompactionItem, CompactionItemFactory, CompactionRole};
...
mod tests {
    ...
    fn test_transform_cwd_transforms_tool_call_arguments() {
        ...
        let worktree = "/home/user/.yis/worktrees/project/ab-uuid-a";
    ...
    fn test_transform_cwd_worktree_to_root_syncback() {
        ...
        let worktree = "/home/user/.yis/worktrees/myproject/fork-a";
    ...
    fn test_transform_cwd_assistant_only_tool_calls_no_content() {
        ...
        let worktree = "/home/user/.yis/worktrees/proj/fork-a";
    ...
    #[test]
    fn upgrade_legacy_reasoning_singular_yis_build_shape() {
