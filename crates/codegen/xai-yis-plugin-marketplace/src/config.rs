//! Parse marketplace sources from `~/.yis/config.toml`.
//!
//! Expected format:
//! ```toml
//! [[marketplace.sources]]
...
/// instead of `~/.yis`/`~/.claude`. Each root is checked for
