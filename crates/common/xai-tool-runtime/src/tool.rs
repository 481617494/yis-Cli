...
/// `filename`, `path`, `metadata`) that the Yis SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the Yis SLOP converter to
    ...
    /// - `path`: file path on the Yis Computer filesystem
